...
if (isset($_POST['edit'])):
	...
	"."$"."globvars['site']['directory']='".substr( $globvars['local_root'], 0, strpos( $globvars['local_root'], "sitebuilder" ) ).$name."/';
	?>";
...
<?//$globvars['site_path'];?>
	<link rel="stylesheet" href="<?=$globvars['site_path'];?>/core/layout/worktype/style.css" type="text/css" />
