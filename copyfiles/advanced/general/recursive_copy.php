...
function copyr($srcdir, $dstdir,$globvars, $offset = '')
{
    ...
    //
    if ($globvars['debugger']['view_files']==true):
                ...
                if(is_file($srcfile)):
                    ...
                    if($ow > 0):
                        ...
                        if(copy($srcfile, $dstfile)):
                            ...
                            if($globalvars['debugger']['view_files']==true):
...
function delr($source,$globvars){
    if ($globvars['debugger']['view_files']==true):
		echo '<font style=" font-size: 8px; font-family: Verdana; color: #FF0000">DEBUGGER ENABLED (copy functions) !<br><strong>deldir:</strong> '.$source.' <strong>';
