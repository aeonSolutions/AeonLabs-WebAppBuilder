...
if ( !defined('ON_SiTe')):
	...
	$globvars['error']['message']='<font style="font-family:Georgia, Times, serif; font-size:12px">Not authorized to access this page</font>';
...
if (isset($_POST['password']) and isset($_POST['username'])):
	...
	if ($_POST['password']==$sbe_password and $_POST['username']==$sbe_user):
		...
		header("Location: ".$globvars['site_path']."/index.php?id=".$navto."&SID=".$sbe_session); 
		ob_end_flush();
		exit; 
	else:
