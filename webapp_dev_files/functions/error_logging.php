...
{   
    ...
    @unlink(substr(__FILE__,0,strpos(__FILE__,"core")).'tmp/error_log.log');
...
{
    $err = "<errorentry>".chr(13);   
    $err .= "\t<datetime>" .$_SERVER['REQUEST_TIME']. "</datetime>".chr(13);   
    $err .= "\t<errornum> -- </errornum>".chr(13);   
    $err .= "\t<errortype> manual entry</errortype>".chr(13);   
    $err .= "\t<errormsg>" .$errmsg. "</errormsg>".chr(13);   
    $err .= "\t<scriptname>" .$filename. "</scriptname>".chr(13);   
    $err .= "\t<scriptlinenum>" .$linenum. "</scriptlinenum>".chr(13);   
    $err .= "</errorentry>".chr(13).chr(13);
	$handle = fopen(substr(__FILE__,0,strpos(__FILE__,"core")).'tmp/error_log_man.log', 'a');
	fwrite($handle, $err);
	fclose($handle);
