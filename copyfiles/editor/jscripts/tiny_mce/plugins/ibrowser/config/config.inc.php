...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		...
		array (																		
			...
			'value'   	=> $staticvars['upload'].'/editor/images/',												
	...
	$cfg['ilibs_dir'] 	   = array($staticvars['upload'].'/upload/editor/images/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
