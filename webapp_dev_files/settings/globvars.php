...
//$globvars['']='';
	...
	$globvars['warnings']='&nbsp;';// used for display warning messages on the layout
	//module related
	$globvars['module']['id']=-1; // id -1 means no id parsed
	$globvars['module']['location']='wizard/info.php'; // modules location to load
	//errors
